...
<body>
        ...
        <div class="container"><a class="navbar-brand d-flex align-items-center" href="index"><span class="bs-icon-sm bs-icon-rounded bs-icon-primary d-flex justify-content-center align-items-center me-2 bs-icon"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" fill="none">
            ...
            <div class="collapse navbar-collapse" id="navcol-5">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item"><a class="nav-link" href="ernaehrung" style="color: var(#8d97ad);">Ernährung</a></li>
                    <li class="nav-item"><a class="nav-link" href="plan" style="color: var(--bs-navbar-color);">Gym Pläne</a></li>
                    <li class="nav-item"><a class="nav-link" href="anatomie" style="color: var(--bs-navbar-active-color);">Anatomie</a></li>
    ...
    <main>
        <section style="min-width: 800px;padding: 50px;">
            <h2>Muskelgruppen</h2>
            <figure class="figure"><img class="rounded figure-img shadow" data-bs-toggle="tooltip" data-bss-tooltip="" src="assets/img/muskelgruppen.png" style="height: auto;width: 100%;display: block;" title="Muskelgruppen">
                <figcaption class="figure-caption">Die Muskelgruppen des Menschen</figcaption>
            </figure>
        </section>
    </main>
