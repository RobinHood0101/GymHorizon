...
<x-header></x-header>
<header>
    <h1 style="padding: 15px;text-align: center;">Trainingsplan erstellen</h1>
</header>
<main style="padding: 70px;">
    <form style="max-width: 600px;" action="{{ route('trainingsplan.store') }}" method="POST">
        @csrf
        ...
        <button type="submit" class="btn btn-primary mt-3">Plan erstellen</button>
    </form>
