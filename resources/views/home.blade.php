            ...
            <div class="row h-100">
                <div class="col-md-6 text-center text-md-start d-flex d-sm-flex d-md-flex justify-content-center align-items-center justify-content-md-start align-items-md-center justify-content-xl-center">
                    <div style="max-width: 350px;">
                        <h1 class="text-uppercase fw-bold" style="color: var(--bs-body-bg);">@guest
                                ERFÜLLE DEINE TRÄUME!
                            @endguest @auth
                                Willkommen {{ Auth::user()->name }}!
                            @endauth</h1>
                        <p class="my-3" style="color: var(--bs-body-bg);">Alles rund ums Thema Fitness und Gym</p>@guest
                            <a class="btn btn-primary btn-lg me-2" role="button" href="register">Starte jetzt</a>
                        @endguest
                    </div>
                </div>
            </div>
